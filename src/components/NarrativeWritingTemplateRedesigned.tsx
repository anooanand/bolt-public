...
import { BookOpen, ChevronDown, ChevronUp, HelpCircle, Lightbulb, Target, Users, MapPin, Zap, Sparkles, Clock, Star, CheckCircle } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-600 rounded-2xl flex items-center justify-center mr-4 shadow-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Create compelling stories with guided planning and NSW-aligned structure</p>
                </div>
              </div>
              
              {/* Progress Indicator */}
              <div className="text-right">
                <div className="text-sm text-gray-600 mb-1">Template Progress</div>
            ...
            <div className="flex items-center space-x-4 mt-6">
              <button
                ...
                className={`flex items-center px-8 py-3 rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg ${
                  isTemplateComplete
                    ? 'bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 text-white shadow-indigo-200'

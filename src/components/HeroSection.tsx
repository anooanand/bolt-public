        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-8">
            ...
            <button 
              ...
              className="px-10 py-5 text-xl font-bold rounded-2xl bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 border-4 border-white cursor-pointer"
            >
              Try It For Free!

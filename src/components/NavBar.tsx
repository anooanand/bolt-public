...
import { PenTool, BookOpen, User, Home, LogIn, LogOut } from 'lucide-react';
...
export const SimpleNavBar: React.FC<SimpleNavBarProps> = ({ 
  ...
  const { user, authSignOut } = useAuth(); // FIXED: Changed from 'signOut' to 'authSignOut'
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <button
                  onClick={handleSignOut} // FIXED: Now calls the proper async handler

          ...
          tips.map((tip) => (
            ...
            >
              ...
              <button 
                ...
                className="absolute -top-2 -right-2 w-6 h-6 flex items-center justify-center rounded-full shadow-md transition-all duration-300 transform hover:scale-110 bg-yellow-500 text-white hover:bg-yellow-600"

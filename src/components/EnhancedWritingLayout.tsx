...
export function EnhancedWritingLayout({
  ...
  return (
    <div className="enhanced-writing-layout bg-gray-50 overflow-hidden min-h-0 h-full flex flex-row">
      ...
      <div className="writing-left-section flex-1 flex flex-col min-h-0" style={{ flex: '1' }}>
      ...
      {showWritingBuddy && (
        <div className="writing-buddy-panel bg-white border-l border-gray-200 flex flex-col min-h-0" style={{ flex: '1', minWidth: '300px' }}>
